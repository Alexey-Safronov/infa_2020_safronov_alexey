...
def eskimo(Surface, x, y, size):
	...
	arc(Surface, black, (x-19*size, y - 75*size, 40*size, 10*size), 0, np.pi,1)
	#arms
...
#drawing igles
igla(screen, 250, 400, 0.4)
igla(screen, 50, 370, 0.4)
igla(screen, 200, 450, 1)
igla(screen, 150, 500, 0.4)
igla(screen, 220, 550, 0.3)
#drawing eskimos
eskimo(screen, 500, 350, 0.2)
eskimo(screen, 550, 370, 0.2)
eskimo(screen, 525, 400, 0.3)
eskimo(screen, 470, 450, 0.5)
eskimo(screen, 550, 520, 0.6)
eskimo(screen, 500, 650, 1)
#drawing cats
cat_with_fish(screen, 650, 750, 1)
cat_with_fish(screen, 100, 650, 1)
cat_with_fish(screen, 300, 700, 1)
cat_with_fish(screen, 50, 550, 1)
